...
const siteConfig = {
  personal: {
    ...
    description: 'Sai Sathwik Sadasivapetkar is a dynamic young entrepreneur and the Chief Executive Officer of SSS Group of Companies, leading the organization at just 19 years of age. Despite his youth, Sathwik has already made a powerful impression in the business world, guiding SSS Group with vision, energy, and a commitment to innovation.\n' +
        ...
        '\n' +
        'Under Sathwik’s leadership, SSS Group has expanded its footprint, diversified its services, and sharpened its strategic focus. He is a big believer in leveraging digital tools and data-driven decision-making to streamline operations and deliver smarter, more efficient solutions to clients. His forward-thinking mindset has driven the company’s entry into new markets and helped SSS Group scale rapidly.\n' +
        '\n' +
        'In short, Sai Sathwik Sadasivapetkar is a rare combination of youthful energy and strategic insight—leading SSS Group of Companies with ambition, integrity, and a long-term vision for success.',
